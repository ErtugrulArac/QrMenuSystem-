        ...
        <div className='w-full max-w-screen-2xl mx-auto px-4 md:px-6 lg:px-8 py-4 md:py-6'>
          <div className='flex items-center gap-2 md:gap-4'>
            ...
            <div className='min-w-0 flex-1'>
              <h1 className='text-xl md:text-2xl lg:text-3xl font-bold text-gray-900'>Ürünler</h1>
              <p className='text-gray-600 text-xs md:text-sm mt-0.5 md:mt-1'>Menü ürünlerini ekle ve düzenle</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='bg-white rounded-lg md:rounded-xl border border-gray-200 p-4 md:p-6 mb-6 md:mb-8'>
          <div className='flex items-start gap-3 md:gap-4'>
            <div className='flex-shrink-0'>
              <span className='inline-flex items-center justify-center h-10 w-10 md:h-12 md:w-12 rounded-lg md:rounded-xl bg-green-100'>
